(function(t) {
    ...
    function m(t) {
        return a.p + "https://jscss-2088844-1305953556.ap-guangzhou.run.tcloudbase.com/cy/" + ({
            Mine: "Mine"
        } [t] || t) + "." + {
            Mine: "4c160b23"
        } [t] + ".js"
    ...
    a.e = function(t) {
        ...
        n[t] ? A.push(n[t]) : 0 !== n[t] && i[t] && A.push(n[t] = new Promise((function(A, i) {
            for (var e = "https://jscss-2088844-1305953556.ap-guangzhou.run.tcloudbase.com/cy/" + ({
                        Mine: "Mine"
                    } [t] || t) + "." + {
                        Mine: "14074204"
